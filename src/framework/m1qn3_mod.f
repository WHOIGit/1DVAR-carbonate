      module m1qn3_mod
      USE hessian_mod, ONLY: update_hessian
...
c
      logical reverse
      integer n,impres,io,imode(2),omode,niter,nsim,iz(5),ndz,indic,
     &    izs(*)
      real rzs(*)
...
900   format (/" M1QN3 (Version 3.1, June 2006): entry point"/
...
c
      ...
      integer n,impres,io,imode(2),omode,niter,nsim,m,jmin,jmax,indic,
     &    izs(*)
      real rzs(*)
...
c
     ...
     &    gnorm,eps1,ff,preco,precos,ys,den,dk,dk1,ps,ps2,hp0
c
c         parametres
c
...
c
  ...
  510     continue
     ...
     /                   precos,diag,alpha,ybar,sbar,izs,rzs,dzs)
          ...
          call update_hessian(sbar(:,jcour),ybar(:,jcour)) ! LUO_added
...
c
!     write accepted cost/param values
      write(results_un,'(102(1x,1PG19.12,:))') niter,f,x
...
c
      ...
      real rzs(*)
      double precision depl(n),precos,diag(n),alpha(nm),ybar(n,*),
     &    sbar(n,*),aux(n),dzs(*)
...
c
      logical reverse
      integer n,imp,io,logic,nap,napmax,indic,izs(*)
      real rzs(*)
